...
import com.example.PROYECTOSEMINARIO.RESTAURANTE.ADAPTADOR_CLIENTE.EsVRestaurante;
import com.example.PROYECTOSEMINARIO.RESTAURANTE.ADAPTADOR_CLIENTE.VResAdapter1;
...
public class VER_RESTAURANTE_CLIENTE extends AppCompatActivity implements onLoadData {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ver_restaurante_cliente);
