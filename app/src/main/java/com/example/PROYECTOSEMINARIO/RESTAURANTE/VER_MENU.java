...
public class VER_MENU extends AppCompatActivity {
    ListView listamenu;
    ImageButton atras;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        atras.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(VER_MENU.this, INFO_RESTAURANTE.class));
                finish();
            }
        });
        loadComponents();
        ...
        client.get ("http://192.168.100.102:8000/api/1.0/menus",  new JsonHttpResponseHandler(){
            ...
            public void onSuccess(int statusCode, Header[] headers, JSONArray jsonArray) {
                ...
                try {
                    ...
                    //VerMenuAdapter adapter =  new VerMenuAdapter(VER_MENU.this,list_data);
