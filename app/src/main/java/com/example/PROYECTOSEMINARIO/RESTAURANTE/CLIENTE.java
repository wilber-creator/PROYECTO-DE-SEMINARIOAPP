...
public class CLIENTE extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cliente_1);
        ...
        atrasVC.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(CLIENTE.this, ACTIVIDAD_MAIN.class));
        ...
        pedido.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent t=new Intent(CLIENTE.this, VER_RESTAURANTE_CLIENTE.class);
        ...
        carrito.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent t=new Intent(CLIENTE.this, VER_PEDIDO.class);
                t.putExtra("_id",_id.getText());
                startActivity(t);
            }
        });
        ...
        editar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent t=new Intent(CLIENTE.this, EDITAR_CLIENTE.class);
