...
public class IMAGEN_RESTAURANTE extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SEND.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                    ...
                    try {
                        ...
                        client.post(Data.UPLOAD_RESTORANT, params, new JsonHttpResponseHandler(){
                            public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                                Toast.makeText(IMAGEN_RESTAURANTE.this, "EXITO", Toast.LENGTH_LONG).show();
                ...
                startActivity(new Intent(IMAGEN_RESTAURANTE.this, INFO_RESTAURANTE.class));
            }
        });
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                IMAGEN_RESTAURANTE.this.startActivityForResult(camera, CODE);
