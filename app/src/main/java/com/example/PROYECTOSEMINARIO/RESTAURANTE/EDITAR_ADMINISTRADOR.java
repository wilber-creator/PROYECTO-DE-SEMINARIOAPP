       ...
       // TextView _id = findViewById(R.id.idclient2);
        ...
        client.patch(Data.REGISTER_CLIENTE+"?id="+_id, params, new JsonHttpResponseHandler() {
            public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
              ...
              /*
                AlertDialog alertDialog = new AlertDialog.Builder(EDITAR_ADMINISTRADOR.this).create();
                try {
                    ...
                    if (resp == 200) {
                        ...
                        alertDialog.setButton(AlertDialog.BUTTON_NEUTRAL, "OK", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                Intent intent = new Intent(EDITAR_ADMINISTRADOR.this, ADMINISTRADOR.class);
