package com.example.PROYECTOSEMINARIO.RESTAURANTE.adapter2;
...
import com.example.PROYECTOSEMINARIO.RESTAURANTE.EDITAR_1;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            ...
            if (LISTMENU.get(position).getFoto().equals("No IMAGE")) {
                Glide.with(context)
                        .load("https://image.flaticon.com/icons/png/512/45/45332.png")
                        .centerCrop()
                        .into(foto);
            } else {
                Glide.with(context)
            ...
            //BUTTON DE EDITAR MENUS

            editar.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent = new Intent(context, EDITAR_1.class);
