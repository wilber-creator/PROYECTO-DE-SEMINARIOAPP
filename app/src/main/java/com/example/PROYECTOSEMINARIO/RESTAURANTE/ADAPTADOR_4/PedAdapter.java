...
import com.example.PROYECTOSEMINARIO.RESTAURANTE.EDITAR_PEDIDO;
...
public class PedAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView==null){
            ...
            editar.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent = new Intent(context, EDITAR_PEDIDO.class);
    ...
    private void deleteMenu(final String id) {
        ...
        client.delete("http://192.168.100.102:8000/api/1.0/orden" + "?id=" + id, new JsonHttpResponseHandler() {
            @Override
